                        ...
                        if dim >= 2:
                            ...
                            while count < num_of_x:
                                if expression[i] == "x" and expression[i + 1] == "_":
                                    current_ind = i + 2
                                    substr = ""
                                    while ord(expression[current_ind]) in range(48, 58):
                                        substr = substr + expression[current_ind]
                                        current_ind += 1
                                    count += 1
                                    expression = expression[:i] + str(true_point[int(substr) - 1]) + expression[current_ind:]
                                i += 1
                        elif dim == 1:
                            count = 0
                            i = 0
